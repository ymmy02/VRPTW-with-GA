...
def plot_graphs(path="", generations, nvehicle_avgs, \
    ...
    _plot(path+"distance_avg_best.png", title, generations, distance_avg, \
            distance_bests, "Genration", "Avarage of Distance", \
            "Avarage of Distance", "Best Distance")

def draw_routings(path="", nodes, solutions):
    G = nx.Graph()
