...
def main(dirname):
    ...
    plot(dirname+filename, title, ge[0], nvavg_mean,  nvavg_sem, \
    ...
    plot(dirname+filename, title, ge[0], diavg_mean,  diavg_sem, \
            [], [], "Genration", "Distance", \
            "Distance", "")
    ...
    plot(dirname+filename, title, ge[0], nvbst_mean,  nvbst_sem, \
            [], [], "Genration", "Number of Vehicles", \
            "Vehicles", "")
    ...
    plot(dirname+filename, title, ge[0], dibst_mean,  dibst_sem, \
            [], [], "Genration", "Distance", \
            "Vehicles", "")
    ...
    plot(dirname+filename, title, ge[0], nvavg_mean,  nvavg_sem, \
            nvbst_mean, nvbst_sem, "Genration", "Number of Vehicles", \
            "Avarage", "Best")
    ...
    plot(dirname+filename, title, ge[0], diavg_mean,  diavg_sem, \
            dibst_mean, dibst_sem, "Genration", "Distance", \
            "Avarage", "Best")
